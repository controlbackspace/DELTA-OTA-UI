...
| Sept 27 (ran Sept 26) | D5 Interruption / power loss | SIM: drop mid-transfer (3 blocks OK → 5 timeouts, 2.04 never signaled = no commit, partial ≠ payload); serving proven read-only (payload bit-identical across 130+ fetches); staging deterministic. Evidence: `testing-deliverables/day-05-2026-09-26/` (03/04). Found + fixed: WinError 10054 vs timeout conflation in harness client | Physical power-cut + on-device A/B proof stay CODE (`_abortOta`, `_rollbackToBackup`, factory fallback) |
